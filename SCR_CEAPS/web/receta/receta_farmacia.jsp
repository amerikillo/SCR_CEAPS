    ...
    <body onload="focoInicial();">
        ...
        <div class="container-fluid">
            ...
            return tabular(event, this);"  value="<%=nom_com%>">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="receta_farmacia.jsp" class="btn btn-info btn-sm btn-block" ><span class="glyphicon glyphicon-refresh"></span></a>
                                        </div>
                                        <br/>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12">
                                                    <label for="carnet" class="col-sm-2 control-label">Exp.</label>
                                                    <div class="col-sm-4">
                        ...
                        <div class="panel-footer">
                            <div class="row" id="tablaBotones">
                                ...
                                <div class="hidden">
                                    ...
                                    <button class="btn btn-block btn-primary" name="btn_nueva" value="1" id="btn_Nueva" onclick="return confirm('Desea Finalizar esta Receta?')">Guardar Receta</button>
                                </div>
                                <!--div class="col-lg-3">
        ...
        $(function() {
            ...
            <%
                try {
                    con.conectar();
                    try {
                        ResultSet rset = con.consulta("select id_cau, des_cau from causes where id_cau not in (999,998)");
                        while (rset.next()) {
