...
<%
    ...
    String que = "", titulo = "Alta de Usuarios", nombre = "", user = "", apeP = "", apeM = "", ocultarA = "hidden", ocultarG = "", disa = "", id = "",uni="",pass="",form="../../Usuarios?tipo=0";
                    ...
                    <form class="form-horizontal" role="form" name="formulario_pacientes" id="formulario_pacientes" method="get" action="<%=form%>">
                        <div class="panel-body">                            
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" id="unidad" name="unidad" type="text" placeholder="Unidad" size="1" value="<%=uni%>">
                                </div>
                            </div><br/>
                            <div class="row">
                                            ...
                                            function devuelveFolio(data) {
                                                ...
                                                for (var i = 0; i < json.length; i++) {
                                                    ...
                                                    if (ban === '1') {
                                                        ...
                                                        $('#ape_mat').val("");
                                                        $('#nombre').val("");
                                                        self.location = 'usuario_administrador.jsp';
                                                    }
                                                    alert(mensaje);
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    if (ban === '2') {
                                                        ...
                                                        $('#ape_mat').val("");
                                                        $('#nombre').val("");
                                                        window.location.href = 'usuario_administrador.jsp';
                                                    }
                                                    alert(mensaje);
                                                },
                                                error: function () {
