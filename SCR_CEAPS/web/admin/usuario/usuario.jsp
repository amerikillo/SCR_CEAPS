                                ...
                                <table class="table table-striped table-bordered" id="datosPacientes">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" href="alta_usuario.jsp?que=edi&id=<%=rset.getString(1)%>"><span class="glyphicon glyphicon-edit"></span></a>
                                                <a class="btn btn-sm btn-danger" onclick="EliminarUsuario(<%=rset.getString(1)%>)" href="#"><span class="glyphicon glyphicon-remove"></span></a>
                                            </td>                                                                     
                                        </tr>
                                        <%
                                                }
        ...
        <script type="text/javascript">
                                                    ...
                                                    function EliminarUsuario(id) {
                                                        ...
                                                        if (e) {
                                                            $.ajax({
                                                                url: url,
                                                                data: {que: "eli", id_usu: id},
                                                                success: function (data) {
                                                                    var json = JSON.parse(data);
                                                                    if (json[0].resp === "si") {
                                                                        alert("Se eliminó correctamente al usuario");
