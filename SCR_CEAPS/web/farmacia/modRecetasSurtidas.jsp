                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT DISTINCT(fol_rec), nom_com, fecha_hora, id_rec, id_tip from recetas where fol_rec like '%" + fol_rec + "%' and nom_com like '%" + nom_pac + "%' and transito!=1 and baja=0 or baja=2 order by id_rec asc limit 0,50 ;");
                                        while (rset.next()) {
                                %>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-8">
                                                <table class="table table-bordered">
                                                    ...
                                                    <%
                                                        ResultSet rset2 = con.consulta("select cla_pro, des_pro, can_sol, cant_sur, fol_det, indicaciones from recetas where id_rec = '" + rset.getString(4) + "' and cant_sur!=0 ");
                                                        while (rset2.next()) {
                                                    %>
                                                    <tr>
