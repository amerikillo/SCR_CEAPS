                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <%
                                    int totalReceta = 0, recetaPorSur = 0, recetasCancel = 0;
                                    int numRecetas = 0, numRecetasP = 0;
                                    ...
                                    try {
                                        ...
                                        while (rset.next()) {
                                            if (rset.getString("baja").equals("2")) {
                                                numRecetasP++;
                                            } else {
                                                numRecetas++;
                                            }
                                ...
                                %>
                                <div class="row"><strong class="col-sm-12">Total de Recetas: <%=totalReceta%></strong></div>
                                <div class="row"><strong class="col-sm-12">Recetas por Surtir: <%=recetaPorSur%></strong></div>
                                <div class="row"><strong class="col-sm-12">Recetas Surtidas: <%=numRecetas%></strong></div>
                                <div class="row"><strong class="col-sm-12">Recetas Pendientes: <%=numRecetasP%></strong></div>
                                <div class="row"><strong class="col-sm-12">Recetas Canceladas: <%=recetasCancel%></strong></div>
                                <hr/>
                                <div class="row"><strong class="col-sm-12">Global | Solicitado/Surtido: <%=gSumSol%> / <%=gSumSur%></strong></div>
                                <div class="row"><strong class="col-sm-12">Recetas Surtidas | Solicitado/Surtido: <%=sumSol%> / <%=sumSur%></strong></div>
                            </div>
                        </div>
                        <%
                            }
                            ...
                            <div class="panel-body">
                                <%
                                    try {
                                        ...
                                        ResultSet rset = con.consulta(qry);
                                        while (rset.next()) {
                                            String pend = rset.getString("baja");
                                %>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-8">
                                                <table class="table table-bordered">
                                                    ...
                                                    <%
                                                        ResultSet rset2 = con.consulta("select cla_pro, des_pro, can_sol, cant_sur, fol_det, indicaciones from recetas where id_rec = '" + rset.getString(4) + "' and can_sol!=0 ");
                                                        while (rset2.next()) {
                                                    %>
                                                    <tr>
