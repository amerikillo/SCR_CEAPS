                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT DISTINCT(fol_rec), nom_com, fecha_hora, id_rec, medico from recetas where fol_rec like '%" + fol_rec + "%' and nom_com like '%" + nom_pac + "%' and transito!=0 and baja=0 and id_tip='1' order by id_rec asc ;");
                                        while (rset.next()) {
                                %>
                                <form action="../Farmacias" name="form_<%=rset.getString(4)%>">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <h4>Folio: <%=rset.getString(1)%> ||  <%=rset.getString("medico")%> </h4>
                                                </div>
                                                <div class="hidden">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" value="<%=rset2.getString(3)%>" name="sol_<%=rset2.getString(5)%>" id="sol_<%=rset2.getString(5)%>" readonly="true" /></td>
                                                        <%if (F_sur > 0) {%>
                                                    <td><input type="text" class="form-control" value="<%=rset2.getString(4)%>" name="sur_<%=rset2.getString(5)%>" id="sur_<%=rset2.getString(5)%>" onchange="desactivaBtnSurtir('<%=rset.getString(4)%>', '<%=rset2.getString(5)%>')" /></td>
                                                        <%} else {%>
