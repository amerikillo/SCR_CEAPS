                                ...
                                <body link=blue vlink=purple>
                                    ...
                                    <table width="980" border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" class="Estilo9"><%=(Math.floor(rset.getDouble("sur") / rset.getDouble("amp_pro")))%></td>
                                            <td align="center" class="Estilo9"><%=(rset.getDouble("sur") % rset.getDouble("amp_pro"))%></td>
