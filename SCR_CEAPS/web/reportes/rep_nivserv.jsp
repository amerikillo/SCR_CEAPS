        ...
        <div style="background-color:#FFFFFF; padding:10px; width:800; margin:auto" >
            ...
            <form action="rep_nivserv.jsp?cla_uni=<%=request.getParameter("cla_uni")%>" method="post">
                ...
                <div class="row">
                    ...
                    <h4 class="col-sm-1">al</h4>
                    <div class="col-sm-2">
                        <input type="date" class="form-control" id="f2" name="f2" />
                    </div>
                    <div class="col-sm-2">
                        <input type="submit" class="btn btn-block btn-primary" value="Por Fechas" name="submit" id="submit"/>
                    </div>
                    <div class="col-sm-2">
                        <a class="btn btn-success" href="gnr_rep_nivserv.jsp?f1=<%=fecha1%>&f2=<%=fecha2%>&cla_uni=<%=request.getParameter("cla_uni")%>">
