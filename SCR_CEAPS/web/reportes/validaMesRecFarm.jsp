...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#ffffff" onload="fillCategory2()">
        ...
        <table width="1021" border="0" align="center" cellpadding="2">
            <tr>
                <td width="105"><img src="../imagenes/savi1.jpg" width="115"/></td>
                <td height="63" colspan="2" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="center">
                        <span class="Estilo8">GOBIERNO DEL ESTADO DE MÉXICO<br />
                ...
                <td width="121"><img src="../imagenes/medalfaLogo.png" width="115"/></td>
            </tr>
        ...
        <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="#CCFF99">
                <td height="25" colspan="7" bgcolor="white" id="dateformat">&nbsp;&nbsp;<span class="style76">
                        <script language="JavaScript" type="text/javascript">
                            //document.write(TODAY);	</script>
                        <a href="validaMesRecFarmExcel.jsp" class="style76"></a>
                    </span>&nbsp;&nbsp;<span class="h4">&nbsp;Exportar&nbsp;
                        <img src="../imagenes/exc.jpg" width="37" height="29" border="0" usemap="#Map2"/></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <%
                        String ori = "AMBOS";
                        try {
        ...
        <map name="Map2" id="Map2">
            <area shape="rect" coords="5,2,32,28" href="validaMesRecFarmExcel.jsp?f1=<%=request.getParameter("f1")%>&f2=<%=request.getParameter("f2")%>&boton=Show ALL&unidad=<%=request.getParameter("cla_uni")%>&ori=<%=request.getParameter("ori")%>" />
        </map>
