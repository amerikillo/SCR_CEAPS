...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>:: REPORTE DIARIO SALIDA COLECTIVA ::</title>
    ...
    <body bgcolor="#ffffff" onload="">
            ...
            <tr>
                ...
                <td width="453"><div align="center">
                        <table width="555" border="0" align="center" cellpadding="2" cellspacing="3">
                            <form action="diarioRecetaCol.jsp" method="post" >
                                <tr>
                                    <td colspan="14">
                                        <div id="item21" style="display:none" align="justify" >
                                ...
                                <tr>
                                    <center><label class="h2 text-center">CONSUMO DIARIO RECETA COLECTIVA</label></center>
                                    <br/><br/>
        ...
        <table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="">
                <td height="25" colspan="7" bgcolor="" id="dateformat">&nbsp;&nbsp;<span class="style76">
                        <script language="JavaScript" type="text/javascript">
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    <form action="diarioRecetaCol.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
