...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#ffffff" onload="fillCategory2()">
        ...
        <table width="1048" border="0" align="center" cellpadding="2">
            <tr>
                <td width="104"><img src="../imagenes/savi1.jpg" width="90" alt="Logo" /></td>
                ...
                <td width="96"><img src="../imagenes/medalfaLogo.png" width="90" alt="Logo" /></td>
            </tr>
        </table>
        <table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="#CCFF99">
                <td height="25" colspan="7" bgcolor="#FFFFFF" id="dateformat">&nbsp;&nbsp;<span class="style76"> 
                        ...
                        <a href="reportes_val_rc.jsp" class="style76"></a></span>&nbsp;<span class="h4">&nbsp;&nbsp;Exportar</span></span>&nbsp;<img src="../imagenes/exc.jpg" width="37" height="29" border="0" usemap="#Map2"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <%
                            String ori = "AMBOS";
                            try {
        ...
        <map name="Map2" id="Map2">
            <area shape="rect" coords="6,5,33,31" href="validaMesColGlobExcel.jsp?f1=<%=request.getParameter("f1")%>&f2=<%=request.getParameter("f2")%>&boton=Show ALL&unidad=<%=request.getParameter("cla_uni")%>&ori=<%=request.getParameter("ori")%>" />
        </map>
